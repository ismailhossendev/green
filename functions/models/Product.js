...
const ProductSchema = new mongoose.Schema({
    ...
    brand: { type: String, enum: ['Green Tel', 'Green Star'], required: [true, 'Brand is required'] },
    type: { type: String, enum: ['Product', 'Packet', 'Others'], required: [true, 'Product type is required'] },
    purchasePrice: { type: Number, required: [true, 'Purchase price is required'], default: 0 },
    salesPrice: { type: Number, required: [true, 'Sales price is required'], default: 0 },
